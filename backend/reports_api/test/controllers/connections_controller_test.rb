...
class ConnectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post connections_url, params: { connection: { str: @connection.str, type: @connection.type } }, as: :json
    end
  ...
  test "should update connection" do
    patch connection_url(@connection), params: { connection: { str: @connection.str, type: @connection.type } }, as: :json
    assert_response 200
  end
